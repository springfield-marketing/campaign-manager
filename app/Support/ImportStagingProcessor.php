...
class ImportStagingProcessor
{
    ...
    public function promoteReviewItem(
        \App\Models\ImportReviewQueue $reviewItem,
        array $confirmedIds,
        \App\Modules\IVR\Support\PhoneNormalizer $phoneNormalizer,
    ): \App\Models\Client {
        ...
        $client = DB::transaction(function () use (
            ...
            $reviewItem->update([
                'resolution'  => \App\Models\ImportReviewQueue::RESOLUTION_APPROVED,
                'resolved_by' => auth()->id(),
                'resolved_at' => now(),
            ]);
