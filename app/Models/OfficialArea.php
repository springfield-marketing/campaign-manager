...
class OfficialArea extends Model
{
    protected $fillable = [
        'emirate',
        'source_area_id',
    ...
    public function marketingAreas(): BelongsToMany
    {
        return $this->belongsToMany(MarketingArea::class, 'marketing_area_official_areas')
    ...
    public function aliases(): \Illuminate\Database\Eloquent\Relations\MorphMany
    {
        return $this->morphMany(PlaceAlias::class, null, 'entity_type', 'entity_id')
            ->where('entity_type', 'official_area');
    }
